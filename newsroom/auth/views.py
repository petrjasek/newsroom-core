...
from newsroom.auth import blueprint, get_auth_user_by_email, get_company, get_user_by_email, get_company_from_user, get_user_required
...
def token(token_type: Literal["reset_password", "validate"]):
    ...
    return flask.render_template("request_token.html", form=form, token_type=token_type, firebase=app.config.get("FIREBASE_ENABLED"))
...
def change_password():
    ...
    return flask.render_template("change_password.html", form=form, user=user, firebase=app.config.get("FIREBASE_ENABLED"))
